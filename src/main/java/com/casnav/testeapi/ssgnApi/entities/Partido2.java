...
public class Partido2 implements Serializable {
	...
	private Set<Base3> bases = new HashSet<>();
	...
	public Partido2(Integer id, String nome, Integer codigoCor, String nomeCor, Character neutro) {
		this.id = id;
		this.nome = nome;
	...
	public Set<Base3> getBases() {
		return bases;
	}

	public void setBases(Set<Base3> bases) {
		this.bases = bases;
	}
